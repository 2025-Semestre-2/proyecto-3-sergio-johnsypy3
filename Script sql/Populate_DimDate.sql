...
-- Día de la persona negra y la cultura afrodescendiente, 31 de agosto 
	...
	WHERE [Month] = 8 AND [DayOfMonth]  = 31

-- Día de la Independencia, 15 de setiembre 
    UPDATE [dbo].[DimDate]
		SET Holiday = 'Día de la Independencia'
	WHERE [Month] = 9 AND [DayOfMonth]  = 15

-- Día de la abolición del ejercito
	UPDATE [dbo].[DimDate]
		SET HolidayUK = 'Día de la abolición del ejercito'
	WHERE [Month] = 12 AND [DayOfMonth]  = 1

-- Navidad
	UPDATE [dbo].[DimDate]
		SET HolidayUK = 'Navidad'
